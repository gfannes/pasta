...
- [x] Rework pasta.mdl to support MT search of Sections and Schedule
	...
	- [x] Add &mt again, std.Thread.Pool is not supported in Zig anymore in app.zig &#10
		- [x] Implement thread.Pool
			- Start fixed number of threads, default is number of CPUs
			- Reuse existing threads
			- Support for error propagation: error stops everything
		- Integrate into pasta
